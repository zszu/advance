...
<script type="text/javascript" src="<?= Yii::getAlias('@web')?>/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="<?= Yii::getAlias('@web')?>/js/main.min.js"></script>

<!--图表插件-->
<script type="text/javascript" src="<?= Yii::getAlias('@web')?>/js/Chart.js"></script>
